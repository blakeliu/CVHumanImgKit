...
class RTMPose(Landmarker):
    def __init__(self, infer_backend, version=1) -> None:
        ...
        self.std: tuple = (58.395, 57.12, 57.375)
    ...
    def predict(self, image, bboxes: List[np.ndarray] = None):
        """预测lds
...
def regsiter_rtmpose_landmarks(register: Registry):
    register(
        fn=RTMPose, name=RTMPose.__name__, namespace="landmarks", type="face_landmark"
    )
