...
import pathlib
import cv2
from faceimagekit.face_landmarks import rtmface_model
...
def parse_args():
    ...
    parser.add_argument('-engine', '--engine_type', type=str,
                        choices=['MMDeployInfer'], default='MMDeployInfer', help="engine type.")
...
def main():
    ...
    infer = rtmface_model(args.weight_path, backend=args.engine_type, input_shape=args.input_shape)
